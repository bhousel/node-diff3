...
- Open https://github.com/{owner}/{repo}/blob/main/CHANGELOG.md and copy the URL to the new release
- Open https://github.com/{owner}/{repo}/tags and pick the new tag you just pushed
