...
var Diff3$1 = {
  ...
  diffComm: function(file1, file2) {
    ...
    for (var candidate = Diff3$1.LCS(file1, file2);
         candidate !== null;
  ...
  diff3MergeIndices: function (a, o, b) {
    ...
    var m1 = Diff3$1.diffIndices(o, a);
    var m2 = Diff3$1.diffIndices(o, b);
  ...
  diff3Merge: function (a, o, b, excludeFalseConflicts) {
    ...
    var result = [];
    var files = [a, o, b];
    var indices = Diff3$1.diff3MergeIndices(a, o, b);
  ...
  merge: function (a, o, b) {
    var merger = Diff3$1.diff3Merge(a, o, b, true);
    var conflict = false;
    var lines = [];
  ...
  mergeDigIn: function (a, o, b) {
    var merger = Diff3$1.diff3Merge(a, o, b, false);
    var conflict = false;
    var lines = [];
    for (var i = 0; i < merger.length; i++) {
      var item = merger[i];
      if (item.ok) {
        ...
        var c = Diff3$1.diffComm(item.conflict.a, item.conflict.b);
