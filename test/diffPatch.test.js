...
test('diffPatch', function(t) {
  ...
  t.test('did not modify buffer1 or buffer2', function(t) {
    t.strictSame(a0, a);
    t.strictSame(b0, b);
    t.end();
  });
...
test('patch', function(t) {
  t.test('applies a patch against buffer1 to get buffer2', function(t) {
...
test('stripPatch', function(t) {
  const patch = Diff3.diffPatch(a, b);
  const strip = Diff3.stripPatch(patch);

  t.test('removes extra information from the diffPatch result', function(t) {
  ...
  t.test('applies a stripped patch against buffer1 to get buffer2', function(t) {
...
test('invertPatch', function(t) {
  const patch = Diff3.diffPatch(a, b);
  const invert = Diff3.invertPatch(patch);

  t.test('inverts the diffPatch result', function(t) {
  ...
  t.test('applies an inverted patch against buffer2 to get buffer1', function(t) {
